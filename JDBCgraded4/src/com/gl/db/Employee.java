...
public class Employee {
	...
	public static void main(String[] args) throws SQLException, ClassNotFoundException {
		...
		insert(st, 1, "mahesh", "mahesh@gmail.com", "32583425");
		insert(st, 2, "pavan", "pavan@gmail.com", "25356265");
		insert(st, 3, "puneeth", "puneeth@gmail.com", "234818834");
		insert(st, 4, "alan", "alan@.com", "988214441");
		insert(st, 5, "rock", "rock@gmail.com", "8883424428");
		...
		// d. Update the name of employee Id 3 to Karthik and phone number to
		// 1234567890.
